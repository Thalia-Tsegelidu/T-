...
addAppClientTranslation("GR",
                        "APPCLIENT_CHARACTERS","abcdefghijklmnopqrstuvwxyzäöü");
addAppClientTranslation("GR",
                        "APPCLIENT_FULLSCREEN","Εμφάνιση της εφαρμογής σε πλήρη οθόνη");
addAppClientTranslation("GR",
                        "APPCLIENT_HINTLINK","Εμφάνιση άσκησης");
addAppClientTranslation("GR",
                        "APPCLIENT_HELPLINK","Εμφάνιση βοήθειας");
addAppClientTranslation("GR",
                        "APPCLIENT_HELPDESCRIPTION","Υποστήριξη");
addAppClientTranslation("GR",
                        "APPCLIENT_TASKDESCRIPTION","Άσκηση");
addAppClientTranslation("GR",
                        "APPCLIENT_GIVEPARAM","Εισαγάγετε την τιμή της παραμέτρου:");
addAppClientTranslation("GR",
                        "APPCLIENT_CONNECTIONLOST","Η σύνδεση με τον διακομιστή της εφαρμογής διακόπηκε. Δημιουργείται μια νέα σύνδεση.");

addAppClientTranslation("GR",
                        "APPCLIENT_VIDEODELTED","Το βίντεο δεν είναι ακόμα ή δεν είναι πλέον διαθέσιμο στο YouTube.");
addAppClientTranslation("GR",
                        "APPCLIENT_VIDEOFORBIDDEN","Ο δημιουργος του στο YouTube έχει απαγορεύσει την ενσωμάτωση αυτού του ήχου/βίντεο σε άλλους ιστότοπους.");
addAppClientTranslation("GR",
                        "APPCLIENT_VIDEOWRONGURL","Μη έγκυρο YouTube-URL.");

addAppClientTranslation("GR",
                        "APPCLIENT_READSPEECH","εκφώνηση");
